    ...
    if (shouldInstall) {
      ...
      if (nvmNodeItems.length > 0) {
        ...
        lines.push(
          ...
          "  local nvm_prefix nvm_script nvm_status profile needs_nvm_dir needs_nvm_source",
          ...
          "  needs_nvm_dir=0",
          "  needs_nvm_source=0",
          '  /usr/bin/grep -Eq \'^[[:space:]]*(export[[:space:]]+)?NVM_DIR=\' "$profile" 2>/dev/null || needs_nvm_dir=1',
